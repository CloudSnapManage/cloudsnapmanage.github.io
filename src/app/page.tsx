...
function PortfolioContent() {
  ...
  const scrollWrapperProps = isMobile ? { onScroll: handleScroll, className: "h-screen w-full overflow-y-auto" } : { onScroll: setScrollTop };
        ...
        <ScrollWrapper {...scrollWrapperProps}>
            <main className="flex-1 z-10">
              <div className="container mx-auto px-4 md:px-6">
                <section id="hero" className="py-20 md:py-32 flex flex-col md:flex-row items-center gap-8 md:gap-16 min-h-screen">
                  ...
                  <div className="text-center md:text-left animate-in fade-in slide-in-from-bottom-10 duration-1000">
                      ...
                      <TypingAnimation text="Hi, I'm Shrijan" className="text-4xl sm:text-5xl font-extrabold tracking-tight" speed={50} />
